...
CREATE TABLE "prices" (
	...
	"discount_percentage" integer,
	    ...
	    "final_price_uzs" numeric(10, 3) GENERATED ALWAYS AS 
        (price_uzs - price_uzs * COALESCE(discount_percentage, 0)/100) STORED,
    "final_price_usd" numeric(10, 3) GENERATED ALWAYS AS 
        (price_usd - price_usd * COALESCE(discount_percentage, 0)/100) STORED,
